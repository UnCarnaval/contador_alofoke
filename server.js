...
// Archivos JSON (usar memoria en Vercel)
...
function initFiles() {
    // Siempre usar memoria en Vercel
    ...
    // Inicializar puntos si están vacíos
    if (Object.keys(global.puntosData).length === 0) {
